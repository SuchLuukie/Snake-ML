...
* Upper limits of the model.
   I was curious on the limitation of what the model was so I ran multiple env's where the game step reduction when eating food was increased and the upper limit that I saw was around 6500, at that point it cornered itself (Might come back and train the model further to see any more improvement)
